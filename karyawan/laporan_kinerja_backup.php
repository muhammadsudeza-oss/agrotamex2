...
<p class="no-print" style="color: var(--text-muted); font-size: 0.8rem; margin-top: -15px; margin-bottom: 20px;"><i class="fa-solid fa-circle-info" style="color: var(--primary);"></i> <strong>Ketentuan Sanksi:</strong> Apabila terbukti melakukan manipulasi data/pelanggaran (sanksi dikonfirmasi), akumulasi bonus secara otomatis dipotong sebesar 10%.</p>
